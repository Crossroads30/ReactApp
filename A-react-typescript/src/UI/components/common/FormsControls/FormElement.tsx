	...
	return (
		<div className={cl.formControl + ' ' + (hasError ? cl.error : '')}>
			<div>
				...
				{/* передаем в самой форме в 'Field': сам компонент -> (component={FormElement}) и нужный элемент с помощью -> (typeofelement='<названия элемента>') например: <Field  component={Element} typeofelement='input'> */}
			</div>
...
export const createField = (className: string | undefined, placeholder: string | undefined, name: string | undefined, validate: Array<FieldValidatorType> | null, typeofelement, props = {}, text = '') => {
	return (
